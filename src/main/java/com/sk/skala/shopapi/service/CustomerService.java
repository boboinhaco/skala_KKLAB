...
public class CustomerService {
	...
	public Response getAllCustomers(int offset, int count) {
		...
		// TODO 2. customerRepository.findAll(pageable) 조회
		// TODO 3. PagedList로 변환 후 Response.success 반환
		throw new UnsupportedOperationException("TODO: getAllCustomers 구현");
	}
